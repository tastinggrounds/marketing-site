    ...
    <HelmetProvider>
      <div className="LearnScreenContainer">
        <Helmet>
          ...
          />
          <link rel="canonical" href="https://tastinggrounds.com/learn" />
        </Helmet>
        <Heading size={Heading.SIZES.LARGE}>Learn</Heading>
        <div className="LearnScreenBodyContainer">
          <Heading size={Heading.SIZES.XSMALL}>
            At Tasting Grounds, we are students of coffee. Learning more about coffee growing,
            production, roasting, and brewing is a huge part of why we built this specialty
            coffee community.
          ...
          <div className="GuidelinesContainer">
            ...
            <Heading size={Heading.SIZES.XSMALL}>
              Grind size is one of the important and easily-adjustable characteristics
              of your brew process. This is our guide to grind sizes and how to log them
              on Tasting Grounds.
            </Heading>
            {/* eslint-disable-next-line */}
            <Heading size={Heading.SIZES.SMALL}>🍇 <Link to="/learn/flavor-profiles">Guide to Coffee Flavor Profiles</Link></Heading>
            <Heading size={Heading.SIZES.XSMALL}>
              Some coffee flavor profiles can seem too good to be true.
              Coffee tastes like coffee, right? This is our guide on how to detect and
              describe coffee flavor profiles.
            </Heading>
            {/* eslint-disable-next-line */}
            <Heading size={Heading.SIZES.SMALL}>📋  <Link to="/learn/tasting-notes">Guide to Coffee Tasting Notes</Link></Heading>
            <Heading size={Heading.SIZES.XSMALL}>
              Coffee tasting notes can be confusing for both beginners and seasoned
              coffee tasters. This is our guide on how to taste coffee and score tasting
            ...
            <Heading size={Heading.SIZES.XSMALL}>
              ...
              The more coffees and roasters you add to our catalog, the more the rest
              of the community has to explore! We do our best to verify all user created content.
              Read more about our information review and verification standards.
            </Heading>
          </div>
        </div>
        <DownloadButtons />
