    ...
    <HelmetProvider>
      <div className="LearnContentScreensContainer">
        <Helmet>
          ...
          />
          <link rel="canonical" href="https://tastinggrounds.com/learn/tasting-notes" />
        </Helmet>
        ...
        <div className="LearnContentSceensBodyContainer">
          <p>
            ...
            &nbsp;is used for recording tasting notes and scoring a common set of attributes used
            for evaluating the quality of a coffee.
          </p>
          ...
          <p>
            ...
            cake that was just too sweet for you. You wouldn’t rate that a 5 on sweetness just
            because it was extremely sweet, you might rate it lower because it was unpleasantly
            sweet.
          </p>
          <p>
          ...
          <p>
            ...
            “mouthfeel” when referring to the body of a coffee. Terms like watery, creamy, and
            buttery or light, full, and balanced when describing the body. A light body or a
            heavy body that is well suited to the coffee can each be considered pleasant and
            given a high score.
          </p>
          <br />
          ...
          <ul>
            ...
            <li>
              <b>Phosphoric Acid</b>
              &nbsp;- will be more closely associated with the sweetness or creaminess of the
              coffee. You might be reminded of cola or the combination of sweet and tart you
              get from berries or apples.
            </li>
          </ul>
          <p>
            This is not a definitive list of acids that you’ll find in coffee, but it should give
            you some things to think about when evaluating acidity. Like with body, a high acidity
            coffee or a low acidity coffee can each be considered pleasant and given a high score.
          </p>
          <br />
          <Heading size={Heading.SIZES.SMALL}>Sweetness</Heading>
          <p>
            Sweetness can obviously refer to sweetness in the terms you are familiar with, but
            it can also be the result of the perception of a fullness of flavor. Something that
            may help when it comes to thinking of sweetness is the opposite notes of sour,
            astringent, vegetal notes. Sweetness comes from sugars, glycols, alcohols, and
            amino acids in coffee. As a basic rule of thumb, a fruiter sweetness might come
            through in lighter roasts while caramelier, chocolatier sweetness comes in darker
            roasts. Each type of sweetness can be enjoyable and the rating should reflect how
            pleasing it is to you.
          </p>
          <br />
          ...
          <p>
            ...
            the coffee linger. Typically, a shorter, unpleasant linger should get a lower score
            while a longer, positive linger should get a higher score for aftertaste.
          </p>
          <br />
        </div>
        <DownloadButtons />
