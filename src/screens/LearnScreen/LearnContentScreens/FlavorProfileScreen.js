    ...
    <HelmetProvider>
      <div className="LearnContentScreensContainer">
        <Helmet>
          ...
          <meta
            name="description"
            content="The Tasting Grounds specialty coffee app guide to coffee flavor profiles - how to describe coffee flavors and understand the flavor notes your roasters use on their coffee bags"
          />
          <link rel="canonical" href="https://tastinggrounds.com/learn/flavor-profiles" />
        </Helmet>
        ...
        <div className="LearnContentSceensBodyContainer">
          ...
          <p>
            We think you should ask yourself this when it comes to flavor profile
            descriptors -&nbsp;
